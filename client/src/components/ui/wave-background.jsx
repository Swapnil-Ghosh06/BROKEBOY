...
export function Waves({
    className = "",
    strokeColor = "url(#waveGradient)", // Using a vivid linear gradient
    backgroundColor = "transparent", // Transparent to blend with our dark theme
    pointerSize = 0.5
}) {
    ...
    const setLines = () => {
        ...
        for (let i = 0; i < totalLines; i++) {
            ...
            path.setAttribute('opacity', '0.8'); // High opacity for stark visibility
